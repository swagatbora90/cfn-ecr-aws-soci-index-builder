...
// Taskcat config section
== Taskcat Configuration
ifndef::production_build[]
_**This portion of the deployment guide is located in `docs/{guideroot}/{specificdir}/taskcat_configuration.adoc`**_
[.preview_mode]
|===
a|
endif::production_build[]
include::../../{guideroot}/{specificdir}/taskcat_configuration.adoc[]
ifndef::production_build[]
|===
endif::production_build[]
