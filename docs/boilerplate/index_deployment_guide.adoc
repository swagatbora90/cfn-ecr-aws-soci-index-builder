...
include::_deployment_guide.adoc[]
// Get the partner-specific settings.
include::{guideroot}/{specificdir}/_settings.adoc[]
...
:docinfo: shared-footer, shared-header
...
:keywords: SOCI, Partner Solution, AWS, {partner-product-name}
...
include::{includedir}/deployment_cfn/_layout_deployment.adoc[]
